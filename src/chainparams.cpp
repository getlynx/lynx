...
{
    // TODO: If we're making a new coin we might rwanna change this
...
public:
    CMainParams() {
        ...
        consensus.nPowTargetTimespan = 1 * 60 * 60; // kitteh number?  old LC number follows // 3.5 * 24 * 60 * 60; // 3.5 days
